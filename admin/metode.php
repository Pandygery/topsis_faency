...
<div class="container my-4">
  ...
  $cek_alternatif = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tbl_alternatif"));
  $cek_kriteria = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tbl_kriteria"));
  $cek_nilai = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tbl_nilai"));

  if ($cek_alternatif == 0 || $cek_kriteria == 0 || $cek_nilai == 0) {
  ?>
    <div class="alert alert-warning" role="alert">
      <h5>⚠️ Data Belum Lengkap!</h5>
      <p class="mb-0">Silakan lengkapi data berikut terlebih dahulu:</p>
      <ul class="mb-0">
        <?php if ($cek_alternatif == 0) echo "<li>Data Alternatif masih kosong</li>"; ?>
        <?php if ($cek_kriteria == 0) echo "<li>Data Kriteria masih kosong</li>"; ?>
        <?php if ($cek_nilai == 0) echo "<li>Data Nilai masih kosong</li>"; ?>
      </ul>
    </div>
  <?php
    exit; // Stop eksekusi jika data belum lengkap
  }
  ?>
